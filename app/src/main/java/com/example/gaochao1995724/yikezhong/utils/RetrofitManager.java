package com.example.gaochao1995724.yikezhong.utils;
...
public class RetrofitManager {
    ...
    //banner 广告接口
    public static  ApiService  bannerapiService = new Retrofit.Builder()
            .baseUrl("https://www.zhaoapi.cn/")
            .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
            .addConverterFactory(ScalarsConverterFactory.create())
            .client(client)
...
//拿到banner的数据
    public static void getBnner(String url,Map<String,String> map,Observer observer){
        bannerapiService.get(url,map)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(observer);
    }
